...
**Status (2026-09-15, lane 2b): lanes 1, 2 and 2b implemented** (`a3c92a7`,
`a4ef92d`, recorded at `f4dcad8`; lane 2b red `d271a64`, green `de84219`);
**lanes 3 and 4 owed, in that order.** Lane 2b's corrections to this text are
marked "(lane 2b)" in place.
