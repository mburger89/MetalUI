...
**Status, 2026-09-17 (PDT): designed, critic round 1 applied; lane 1 implemented**
(`0e4a209` red, `ba908ad` implementation; its corrections to this design are
`LR-AW`, applied in place below and marked *lane 1*; record §19, lane 1).
