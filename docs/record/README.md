...
| `19-claude-md-full-2026-09-21.md` | the root `CLAUDE.md` verbatim as of `cb2e708` (120 KB), before it was cut to rules only to save context tokens. Every test name, ruling id, divergence row, inert-API row, human-verification row, performance figure and CI hazard the root file used to carry is here, section for section; the root file now points to it |
