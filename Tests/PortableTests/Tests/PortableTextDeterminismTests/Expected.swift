...
let expectedEmits: [PinnedEmit] = [
    ...
    PinnedEmit(glyphs: 24, rects: 0x1a0c1dde9f53c0e2, advance: 0x40740a872b020c48, dirty: [0, 0, 297, 22], coverage: 0x0688fdee153c519a),  // SourceSans3-Regular.otf 26.0pt ×1.0 at (3.5, 40.0) "Affix the fluffy waffle: AV To Ty"
