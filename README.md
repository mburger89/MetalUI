...
On `feat/engine-stage-3` (2026-09-22, plan task 7 stage 3)
the suite reports **1572 tests**. That total includes **97** layout goldens
...
- [`docs/record/`](docs/record/README.md) — the full engineering record:
  ...
  for its third stage — scrolling and `Component` distribution. Two files are
  not task tracks:
