...
- **SwiftUI-alignment plan:** `docs/superpowers/plans/2026-09-12-swiftui-alignment.md`.
  ...
  `specs/2026-09-23-demo-cross-platform-design.md`) and §41 portable font
...
- **Counts (2026-09-23, `feat/font-fallback` — roadmap items 9–11 — merged
  with `master` at `aef88ce`, stage 6a): 1695 tests, 97 goldens, 78
  typecheck guards**, taken the same way: **1695 = 1688 + 3 + 4**, master's
  stage-6a figure below plus `MetalUICrossPlatformTests`' 3 (record §39) and
  font fallback's 4 (record §41), two of them gated, so eleven gated tests
  skip — the nine below, `recordDemoFrames` and `measureFallbackDifferences`.
  The paragraph after next is this line's figure before the merge (1693).
...
- **Master's counts before stage 6a (2026-09-23, `feat/engine-stage-5` — plan task 7 stage 5 — merged
  ...
  font fallback's 4 (record §41, one gated;
